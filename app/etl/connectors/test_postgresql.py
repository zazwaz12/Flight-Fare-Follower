import unittest
import sqlalchemy
from etl.connectors.postgresql import PostgreSqlClient  # Make sure to replace 'your_module' with the actual module where get_engine is defined
...
class PostgreSql(unittest.TestCase):
        def test_get_engine(self):
            ...
            # Calls the get_engine method and check the type
